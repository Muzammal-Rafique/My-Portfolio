...
export default function Hero() {
  const words = [
    ...
    "Learn DevOps Enthusiast",
  ];

  const [code] = useState(`
const profile = {
    name: 'Muzammal Rafique',
    title: 'MERN Stack Developer | React.js & Next.js Developer  | Problem Solver',
    skills: [
        'JavaScript','TypeScript', 'React', 'NextJS', 
        'Node JS', 'Express', 'MySQL', 'MongoDB',
        'GraphQL','REST API' , 'Git', 'Github'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                Frontend Enthusiast 🎨 | MERN Stack Developer 🚀 | Next.js Expert ⚡ | Building sleek UIs & seamless web experiences 💻
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Muzammal-Rafique"
                  target="_blank"
